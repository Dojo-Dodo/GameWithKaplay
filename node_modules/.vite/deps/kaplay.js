// GameEnviroment/node_modules/kaplay/dist/kaplay.mjs
var Oo = (() => {
...
function I(...t18) {
  if (t18.length === 0) return new j(255, 255, 255);
  if (t18.length === 1) {
    if (t18[0] instanceof j) return t18[0].clone();
    if (typeof t18[0] == "string") return j.fromHex(t18[0]);
    if (Array.isArray(t18[0]) && t18[0].length === 3) return j.fromArray(t18[0]);
  } else if (t18.length === 2) {
    if (t18[0] instanceof j) return t18[0].clone();
  } else if (t18.length === 3 || t18.length === 4) return new j(t18[0], t18[1], t18[2]);
  throw new Error("Invalid color arguments");
}
var So = (t18, e, n) => j.fromHSL(t18, e, n);
function ae(t18) {
...
function de(t18, e, n) {
  ...
  if (t18 instanceof j && e instanceof j) return t18.lerp(e, n);
...
var E = class t2 {
  ...
  lerp(e, n) {
    return new t2(de(this.x, e.x, n), de(this.y, e.y, n));
  }
  slerp(e, n) {
...
var wr = new Xt(Date.now());
function Go(t18) {
  return t18 != null && (wr.seed = t18), wr.seed;
}
function he(...t18) {
  return wr.genAny(...t18);
}
function Cr(...t18) {
  return Math.floor(he(...t18.length > 0 ? t18 : [2]));
}
function Mo(t18) {
  return he() <= t18;
}
...
function Ro(t18, e) {
  return t18.length <= e ? t18.slice() : Er(t18.slice()).slice(0, e);
}
function Do(t18) {
  return t18[Cr(t18.length)];
}
function Tr(t18, e) {
...
function Vn(t18, e) {
  ...
  if (n.x != 0) {
    let s = (t18.pos.x - e.p1.x) / n.x, i = (t18.pos.x + t18.width - e.p1.x) / n.x;
    r = Math.max(r, Math.min(s, i)), o = Math.min(o, Math.max(s, i));
  }
  if (n.y != 0) {
    let s = (t18.pos.y - e.p1.y) / n.y, i = (t18.pos.y + t18.height - e.p1.y) / n.y;
    r = Math.max(r, Math.min(s, i)), o = Math.min(o, Math.max(s, i));
  }
  return o >= r && o >= 0 && r <= 1;
}
...
function Ft(t18, e) {
  let n = t18.p2.sub(t18.p1), r = n.dot(n), o = t18.p1.sub(e.center), s = 2 * n.dot(o), i = o.dot(o) - e.radius * e.radius, m = s * s - 4 * r * i;
...
function Or(t18, e) {
  ...
  for (let n = 0; n < e.pts.length; n++) {
    ...
    if (Sn(t18, new Oe(r, o))) return true;
  }
  return false;
}
function Gn(t18, e) {
...
function Qt(t18, e) {
  ...
  for (let r of e.pts) {
    if (Ft(new Oe(n, r), t18)) return true;
    n = r;
  }
  return Gn(t18, e.pts[0]) ? true : et(e, t18.center);
}
function Lo(t18, e) {
  for (let n = 0; n < t18.pts.length; n++) if (Or(new Oe(t18.pts[n], t18.pts[(n + 1) % t18.pts.length]), e)) return true;
...
function Ar(t18, e) {
  e = e.sub(t18.center);
  let n = ae(t18.angle), r = Math.cos(n), o = Math.sin(n), s = e.x * r + e.y * o, i = -e.x * o + e.y * r;
  return s * s / (t18.radiusX * t18.radiusX) + i * i / (t18.radiusY * t18.radiusY) < 1;
}
function Tn(t18, e) {
  let n = e.center.sub(t18.center), r = ae(t18.angle), o = Math.cos(r), s = Math.sin(r), i = n.x * o + n.y * s, m = -n.x * s + n.y * o;
  return Ar(new Ke(v(), t18.radiusX + e.radius, t18.radiusY + e.radius, 0), v(i, m));
}
function jo(t18, e) {
  let n = t18.toMat2().inverse;
  return e = new Oe(n.transform(e.p1.sub(t18.center)), n.transform(e.p2.sub(t18.center))), Ft(e, new we(v(), 1));
}
function su(t18, e) {
  ...
  let n = new bt(1 / t18.radiusX ** 2, 0, 0, 0, 1 / t18.radiusY ** 2, 0, 0, 0, -1), r = new bt(1 / e.radiusX ** 2, 0, 0, 0, 1 / e.radiusY ** 2, 0, 0, 0, -1), o = t18.center.x, s = t18.center.y, i = e.center.x, m = e.center.y, u = ae(t18.angle), c = ae(e.angle), p = new bt(Math.cos(u), -Math.sin(u), o, Math.sin(u), Math.cos(u), s, 0, 0, 1), b = new bt(Math.cos(c), -Math.sin(c), i, Math.sin(c), Math.cos(c), m, 0, 0, 1), l = p.inverse, h = b.inverse, d = l.transpose.mul(n).mul(l), C = h.transpose.mul(r).mul(h), g = d.m11, y = d.m12, O = d.m13, A = d.m21, R = d.m22, V = d.m23, x = d.m31, w = d.m32, S = d.m33, G = C.m11, M = C.m12, D = C.m13, L = C.m21, U = C.m22, H = C.m23, Y = C.m31, _ = C.m32, K = C.m33, J = g * R * S - g * V * w - y * A * S + y * V * x + O * A * w - O * R * x, $ = (g * R * K - g * V * _ - g * w * H + g * S * U - y * A * K + y * V * Y + y * x * H - y * S * L + O * A * _ - O * R * Y - O * x * U + O * w * L + A * w * D - A * S * M - R * x * D + R * S * G + V * x * M - V * w * G) / J, Z = (g * U * K - g * H * _ - y * L * K + y * H * Y + O * L * _ - O * U * Y - A * M * K + A * D * _ + R * G * K - R * D * Y - V * G * _ + V * M * Y + x * M * H - x * D * U - w * G * H + w * D * L + S * G * U - S * M * L) / J, Ee = (G * U * K - G * H * _ - M * L * K + M * H * Y + D * L * _ - D * U * Y) / J;
  if ($ >= 0) {
    let k = -3 * Z + $ ** 2, gt = 3 * $ * Ee + Z * $ ** 2 - 4 * Z ** 2, Gt = -27 * Ee ** 2 + 18 * Ee * $ * Z + $ ** 2 * Z ** 2 - 4 * $ ** 3 * Ee - 4 * Z ** 3;
    return !(k > 0 && gt < 0 && Gt > 0);
  } else {
    let k = -3 * Z + $ ** 2, gt = -27 * Ee ** 2 + 18 * Ee * $ * Z + $ ** 2 * Z ** 2 - 4 * $ ** 3 * Ee - 4 * Z ** 3;
    return !(k > 0 && gt > 0);
  }
}
function Io(t18, e) {
  return Sr(t18, new be(e.points()));
}
function Sr(t18, e) {
  let n = t18.toMat2().inverse;
  return e = new be(e.pts.map((r) => n.transform(r.sub(t18.center)))), Qt(new we(v(), 1), e);
}
function iu(t18, e) {
  return t18.x === e.x && t18.y === e.y;
}
function au(t18, e) {
  return e instanceof E ? iu(e, t18.pt) : e instanceof we ? Gn(e, t18.pt) : e instanceof Oe ? Pn(e, t18.pt) : e instanceof W ? Bt(e, t18.pt) : e instanceof be ? et(e, t18.pt) : e instanceof Ke ? Ar(e, t18.pt) : false;
}
function uu(t18, e) {
  return e instanceof E ? Pn(t18, e) : e instanceof we ? Ft(t18, e) : e instanceof Oe ? Sn(t18, e) != null : e instanceof W ? Vn(e, t18) : e instanceof be ? Or(t18, e) : e instanceof Ke ? jo(e, t18) : false;
}
function cu(t18, e) {
  return e instanceof E ? Gn(t18, e) : e instanceof we ? ou(t18, e) : e instanceof Oe ? Ft(e, t18) : e instanceof W ? Bo(e, t18) : e instanceof be ? Qt(t18, e) : e instanceof Ke ? Tn(e, t18) : false;
}
function lu(t18, e) {
  return e instanceof E ? Bt(t18, e) : e instanceof we ? Bo(t18, e) : e instanceof Oe ? Vn(t18, e) : e instanceof W ? Tr(t18, e) : e instanceof be ? Fo(t18, e) : e instanceof Ke ? Io(e, t18) : false;
}
function mu(t18, e) {
  return e instanceof E ? et(t18, e) : e instanceof we ? Qt(e, t18) : e instanceof Oe ? Or(e, t18) : e instanceof W ? Fo(e, t18) : e instanceof be ? Lo(e, t18) : e instanceof Ke ? Sr(e, t18) : false;
}
function pu(t18, e) {
  return e instanceof E ? Ar(t18, e) : e instanceof we ? Tn(t18, e) : e instanceof Oe ? jo(t18, e) : e instanceof W ? Io(t18, e) : e instanceof be ? Sr(t18, e) : e instanceof Ke ? su(e, t18) : false;
}
function Ko(t18, e, n) {
  let r = t18, o = n.p1, s = n.p2, i = e, m = s.sub(o), u = i.cross(m);
...
function du(t18, e, n) {
  ...
  if (t18.x != 0) {
    let i = (n.pos.x - t18.x) / e.x, m = (n.pos.x + n.width - t18.x) / e.x;
    s = v(-Math.sign(e.x), 0), r = Math.max(r, Math.min(i, m)), o = Math.min(o, Math.max(i, m));
  }
  if (t18.y != 0) {
    let i = (n.pos.y - t18.y) / e.y, m = (n.pos.y + n.height - t18.y) / e.y;
...
function ko(t18, e, n) {
  let r = t18, o = n.center, s = e, i = s.dot(s), m = r.sub(o), u = 2 * s.dot(m), c = m.dot(m) - n.radius * n.radius, p = u * u - 4 * i * c;
...
function fu(t18, e, n) {
  ...
  for (let i = 0; i < r.length; i++) {
    let m = r[i], u = Ko(t18, e, new Oe(s, m));
    u && (!o || o.fraction > u.fraction) && (o = u), s = m;
  }
  return o;
}
function hu(t18, e, n) {
  let r = n.toMat2(), o = r.inverse, s = o.transform(t18.sub(n.center)), i = o.transform(e), m = ko(s, i, new we(v(), 1));
  if (m) {
    let u = Dt.rotation(ae(-n.angle)), p = Dt.scale(n.radiusX, n.radiusY).transform(m.point), b = r.transform(m.point).add(n.center), l = b.dist(t18) / e.len();
    return { point: b, normal: u.transform(v(n.radiusY ** 2 * p.x, n.radiusX ** 2 * p.y)).unit(), fraction: l };
  }
  return m;
}
function _o(t18, e, n, r = 64) {
  let o = t18, s = e.len(), i = e.scale(1 / s), m = 0, u = v(Math.floor(t18.x), Math.floor(t18.y)), c = v(i.x > 0 ? 1 : -1, i.y > 0 ? 1 : -1), p = v(Math.abs(1 / i.x), Math.abs(1 / i.y)), b = v(c.x > 0 ? u.x + 1 - t18.x : t18.x - u.x, c.y > 0 ? u.y + 1 - t18.y : t18.y - u.y), l = v(p.x < 1 / 0 ? p.x * b.x : 1 / 0, p.y < 1 / 0 ? p.y * b.y : 1 / 0), h = -1;
  for (; m <= r; ) {
    let d = n(u);
...
var Ke = class t11 {
  ...
  static fromMat2(e) {
    ...
    return u > c ? new t11(v(), u, c, lt(Math.atan2(-i[1], i[0]))) : new t11(v(), c, u, lt(Math.atan2(-m[1], m[0])));
  }
  toMat2() {
...
function gu(t18, e, n, r) {
  let o = e.sub(t18), s = r.sub(n), i = o.cross(s);
  return i < 1e-5 && i > -1e-5 || (i = n.sub(t18).cross(s) / i, i < 0 || i > 1) ? null : t18.add(o.scale(i));
}
var be = class t12 {
  pts;
  constructor(e) {
...
function Vr(t18, e = 10, n = 10) {
  let r = [0], o = [0], i = 1 / (e - 1) / n, m = 0, u = t18(0), c = 0;
  for (let p = 1; p < e; p++) {
    for (let b = 0; b < n; b++) {
      c += i;
      let l = t18(c), h = l.dist(u);
      m += h, u = l;
    }
    r[p] = m, o[p] = c;
  }
...
function Lt(t18, e, n, r) {
  let o = 2 * t18 + e - 2 * r + n, s = -3 * t18 + 3 * r - 2 * e - n, i = e, m = t18;
  return (u) => {
    let c = u * u, p = c * u;
    return o * p + s * c + i * u + m;
  };
}
function Pr(t18, e, n, r, o, s = Lt) {
  let i = s(e.x, (1 - o) * (n.x - t18.x), (1 - o) * (r.x - e.x), n.x), m = s(e.y, (1 - o) * (n.y - t18.y), (1 - o) * (r.y - e.y), n.y);
  return (u) => new E(i(u), m(u));
}
function jt(t18, e, n, r, o = Lt) {
  return Pr(t18, e, n, r, 0.5, o);
}
function Xo(t18, e, n, r, o = Lt) {
  return jt(r.add(t18.sub(e).scale(6)), t18, r, t18.add(r.sub(n).scale(6)), o);
}
function Qo(t18, e, n, r, o, s, i, m = Lt) {
  let u = m(e.x, 0.5 * (1 - o) * (1 + i) * (1 + s) * (e.x - t18.x) + 0.5 * (1 - o) * (1 - i) * (1 - s) * (n.x - e.x), 0.5 * (1 - o) * (1 + i) * (1 - s) * (n.x - e.x) + 0.5 * (1 - o) * (1 - i) * (1 + s) * (r.x - n.x), n.x), c = m(e.y, 0.5 * (1 - o) * (1 + i) * (1 + s) * (e.y - t18.y) + 0.5 * (1 - o) * (1 - i) * (1 - s) * (n.y - e.y), 0.5 * (1 - o) * (1 + i) * (1 - s) * (n.y - e.y) + 0.5 * (1 - o) * (1 - i) * (1 + s) * (r.y - n.y), n.y);
  return (p) => new E(u(p), c(p));
}
function Jo(t18, e, n, r) {
  let o = 2 * t18 + e - 2 * r + n, s = -3 * t18 + 3 * r - 2 * e + n, i = e;
  return (m) => {
    let u = m * m;
...
function bu(t18, e, n, r) {
  let o = 3 * t18 - 6 * e + 3 * n, s = -3 * t18 + 3 * e, i = t18, m = -t18 + 3 * e - 3 * n + r;
  if (xr(m, 0)) {
  ...
  if (l < 0) {
    let y = -u / 3, O = y * y * y, A = Math.sqrt(O), R = -p / (2 * A), V = R < -1 ? -1 : R > 1 ? 1 : R, x = Math.acos(V), S = 2 * $t(A), G = S * Math.cos(x / 3) - o / 3, M = S * Math.cos((x + 2 * Math.PI) / 3) - o / 3, D = S * Math.cos((x + 4 * Math.PI) / 3) - o / 3;
    return [G, M, D].filter(Yt);
  }
  if (l === 0) {
    let y = b < 0 ? $t(-b) : -$t(b), O = 2 * y - o / 3, A = -y - o / 3;
    return [O, A].filter(Yt);
  }
  let h = Math.sqrt(l), d = $t(h - b), C = $t(h + b);
  return [d - C - o / 3].filter(Yt);
}
function yu(t18, e, n, r, o) {
  let s = bu(t18.x - o, e.x - o, n.x - o, r.x - o);
  return s.length > 0 ? Jt(t18, e, n, r, s[0]).y : NaN;
}
function Zo(t18) {
...
function es(t18, e) {
  return (n) => yu(v(0, 0), t18, e, v(1, 1), n);
}
function ts(t18, e = "jump-end") {
  let n = 1 / t18, r = e == "jump-start" || e == "jump-both", o = e == "jump-end" || e == "jump-both", s = 1 / (t18 + (o ? 1 : 0)), i = r ? s : 0;
  return (m) => {
...
function ns(t18, e) {
  ...
  for (let o of [t18, e]) for (let s = 0; s < o.pts.length; s++) {
    ...
    for (let d = 0; d < t18.pts.length; d++) {
      let C = t18.pts[d].dot(u);
...
function vr(t18, e, n, r) {
  let o = r.x - n.x, s = r.y - n.y, i = o * (t18.y - n.y) - s * (t18.x - n.x), m = o * (e.y - n.y) - s * (e.x - n.x);
  return i * m >= 0;
}
function vu(t18, e, n, r) {
  return vr(t18, e, n, r) && vr(t18, n, e, r) && vr(t18, r, e, n);
}
function wu(t18, e, n, r) {
  for (let o of t18) if (o !== e && o !== n && o !== r && vu(o, e, n, r)) return true;
  return false;
}
function Cu(t18, e, n, r) {
  return rs(t18, e, n) && !wu(r, t18, e, n);
}
function Mn(t18) {
  if (t18.length < 3) return [];
  if (t18.length == 3) return [t18];
  let e = [], n = [], r = 0;
  for (let b = 0; b < t18.length; b++) {
    let l = t18[r], h = t18[b];
    (h.x < l.x || h.x == l.x && h.y < l.y) && (r = r), e[b] = b + 1, n[b] = b - 1;
  }
  e[e.length - 1] = 0, n[0] = n.length - 1, xu(t18) || ([e, n] = [n, e]);
  let o = [];
  for (let b = 0; b < t18.length; ++b) rs(t18[n[b]], t18[b], t18[e[b]]) || o.push(t18[b]);
  let s = [], i = t18.length, m = 1, u = 0, c, p;
  for (; i > 3; ) {
    c = e[m], p = n[m];
    let b = t18[p], l = t18[m], h = t18[c];
    if (Cu(b, l, h, o)) s.push([b, l, h]), e[p] = c, n[c] = p, o.splice(o.indexOf(l), 1), --i, u = 0;
    else if (++u > i) return [];
    m = c;
  }
  return c = e[m], p = n[m], s.push([t18[p], t18[m], t18[c]]), s;
}
function os(t18) {
  if (t18.length < 3) return false;
  let e = t18.length - 2, n = t18.length - 1, r = 0, o = t18[n].sub(t18[e]), s = t18[r].sub(t18[n]), i = o.cross(s);
  for (; r + 1 < t18.length; ) if (e = n, n = r, r++, o = t18[n].sub(t18[e]), s = t18[r].sub(t18[n]), o.cross(s) * i < 0) return false;
  return true;
}
var Rn = " !\"#$%&'()*+,-./0123456789:;<=>?@ABCDEFGHIJKLMNOPQRSTUVWXYZ[\\]^_`abcdefghijklmnopqrstuvwxyz{|}~";
var mt = "topleft";
var ss = "monospace";
var yt = "monospace";
var Zt = "linear";
...
`;
var ms = /* @__PURE__ */ new Set(["id", "require"]);
var ps = /* @__PURE__ */ new Set(["add", "fixedUpdate", "update", "draw", "destroy", "inspect", "drawInspect"]);
var Gr = 200;
var ds = 640;
var fs = 65536;
var Dn = /* @__PURE__ */ Symbol.for("kaplay.cancel");
...
var hs = (t18) => t18[0] instanceof j;
var gs = (t18) => t18[0] instanceof E;
var bs = (t18) => typeof t18[0] == "number";
var It = class {
  _items;
  _compareFn;
...
function Mr(t18, e) {
  Bn(t18, "data:text/plain;charset=utf-8," + e);
}
function xs(t18, e) {
  Mr(t18, JSON.stringify(e));
}
function Rr(t18, e) {
  let n = URL.createObjectURL(e);
  Bn(t18, n), URL.revokeObjectURL(n);
}
var Fn = (t18) => t18.match(/^data:\w+\/\w+;base64,.+/);
var vs = (t18) => t18.split(".").slice(0, -1).join(".");
function Ln(t18, e) {
...
var Cs = (t18) => t18 instanceof Error ? t18.message : String(t18);
function Ou(t18) {
  ws.has(t18) || (ws.add(t18), console.warn(t18));
}
function tt(t18, e) {
  Ou(`${t18} is deprecated. Use ${e} instead.`);
}
function on(t18, e) {
...
function Ts(t18) {
  ...
  let e = [], n = 0, r = 0;
  for (; n < t18.length; ) {
    if (r += Su(n + r, t18), Bu(t18[n + r]) && r++, Mu(t18[n + r]) && r++, Ru(t18[n + r]) && r++, Fu(t18[n + r])) {
      r++;
      continue;
    }
...
function Su(t18, e) {
  let n = e[t18];
  if (!Vu(n) || t18 === e.length - 1) return 1;
  let r = n + e[t18 + 1], o = e.substring(t18 + 2, t18 + 5);
  return Es(r) && Es(o) ? 4 : Pu(r) && Du(o) ? e.slice(t18).indexOf(String.fromCodePoint(917631)) + 2 : Gu(o) ? 4 : 2;
}
function Vu(t18) {
  return t18 && xt(t18[0].charCodeAt(0), 55296, 56319);
}
function Es(t18) {
  return xt(Dr(t18), 127462, 127487);
}
function Pu(t18) {
  return xt(Dr(t18), 127988, 127988);
}
function Gu(t18) {
  return xt(Dr(t18), 127995, 127999);
}
function Mu(t18) {
...
function Bu(t18) {
  return typeof t18 == "string" && Au.includes(t18.charCodeAt(0));
}
function Fu(t18) {
...
var De = (t18, e) => Array.isArray(t18) ? t18?.includes(e) : t18 === e;
var We = (t18, e) => Array.isArray(e) ? e.some((n) => t18.has(n)) : t18.has(e);
var sn = (t18, e, n) => {
...
var As = { "Joy-Con L+R (STANDARD GAMEPAD Vendor: 057e Product: 200e)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home", "17": "capture" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } }, "Joy-Con (L) (STANDARD GAMEPAD Vendor: 057e Product: 2006)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "9": "select", "10": "lstick", "16": "start" }, sticks: { left: { x: 0, y: 1 } } }, "Joy-Con (R) (STANDARD GAMEPAD Vendor: 057e Product: 2007)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "9": "start", "10": "lstick", "16": "select" }, sticks: { left: { x: 0, y: 1 } } }, "Pro Controller (STANDARD GAMEPAD Vendor: 057e Product: 2009)": { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home", "17": "capture" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } }, default: { buttons: { "0": "south", "1": "east", "2": "west", "3": "north", "4": "lshoulder", "5": "rshoulder", "6": "ltrigger", "7": "rtrigger", "8": "select", "9": "start", "10": "lstick", "11": "rstick", "12": "dpad-up", "13": "dpad-down", "14": "dpad-left", "15": "dpad-right", "16": "home" }, sticks: { left: { x: 0, y: 1 }, right: { x: 2, y: 3 } } } };
function jn() {
  let t18 = a.globalOpt.pixelDensity ?? 1, e = a.globalOpt.width, n = a.globalOpt.height, r = a.gfx.ggl.gl.drawingBufferWidth, o = a.gfx.ggl.gl.drawingBufferHeight, s = r / t18, i = o / t18, m = 0, u = 0, c = s, p = i;
...
function Ss(t18) {
  return new E(t18.x * a.gfx.viewport.width / a.gfx.width, t18.y * a.gfx.viewport.height / a.gfx.height);
}
function Qe(t18) {
  return new E((t18.x - a.gfx.viewport.x) * a.gfx.width / a.gfx.viewport.width, (t18.y - a.gfx.viewport.y) * a.gfx.height / a.gfx.viewport.height);
}
...
var ju = (t18) => {
  let e = t18.buttons ?? {};
  return { canvas: t18.canvas, buttons: e, buttonsByKey: /* @__PURE__ */ new Map(), buttonsByMouse: /* @__PURE__ */ new Map(), buttonsByGamepad: /* @__PURE__ */ new Map(), buttonsByKeyCode: /* @__PURE__ */ new Map(), loopID: null, stopped: false, dt: 0, fixedDt: 1 / 50, restDt: 0, time: 0, realTime: 0, fpsCounter: new Fr(), timeScale: 1, skipTime: false, isHidden: false, numFrames: 0, mousePos: new E(0), mouseDeltaPos: new E(0), keyState: new vt(), mouseState: new vt(), mergedGamepadState: new Br(), gamepadStates: /* @__PURE__ */ new Map(), lastInputDevice: null, buttonState: new vt(), gamepads: [], charInputted: [], isMouseMoved: false, lastWidth: t18.canvas.offsetWidth, lastHeight: t18.canvas.offsetHeight, events: new ze() };
};
var Ms = (t18) => {
  ...
  function O() {
    e.stopped = true;
    let f = Object.entries(Me), T = Object.entries(br), P = Object.entries(En);
  ...
  function A(f, T) {
    ...
    let P = 0, B = 0, te = (Ae) => {
      ...
      let se = Ae / 1e3, Ze = Math.min(se - e.realTime, 0.25), Rt = t18.maxFPS ? 1 / t18.maxFPS : 0;
      if (e.realTime = se, B += Ze, B > Rt) {
        ...
        B = 0, e.skipTime = false, e.numFrames++, T(Cn, Xa);
      }
      e.loopID = requestAnimationFrame(te);
    };
    te(0);
  ...
  let yn = ne((f) => e.events.on("keyDown", f), (f, T) => e.events.on("keyDown", (P) => De(f, P) && T(P))), xn = ne((f) => e.events.on("keyPress", (T) => f(T)), (f, T) => e.events.on("keyPress", (P) => De(f, P) && T(P))), mr = ne((f) => e.events.on("keyPressRepeat", f), (f, T) => e.events.on("keyPressRepeat", (P) => De(f, P) && T(P))), pr = ne((f) => e.events.on("keyRelease", f), (f, T) => e.events.on("keyRelease", (P) => De(f, P) && T(P))), Mt = ne((f) => e.events.on("mouseDown", (T) => f(T)), (f, T) => e.events.on("mouseDown", (P) => De(f, P) && T(P))), $e = ne((f) => e.events.on("mousePress", (T) => f(T)), (f, T) => e.events.on("mousePress", (P) => De(f, P) && T(P))), vn = ne((f) => e.events.on("mouseRelease", (T) => f(T)), (f, T) => e.events.on("mouseRelease", (P) => P === f && T(P)));
  function F(f) {
  ...
  let ut = ne((f) => e.events.on("gamepadButtonPress", (T, P) => f(T, P)), (f, T) => e.events.on("gamepadButtonPress", (P, B) => De(f, P) && T(P, B))), dr = ne((f) => e.events.on("gamepadButtonDown", (T, P) => f(T, P)), (f, T) => e.events.on("gamepadButtonDown", (P, B) => De(f, P) && T(P, B))), fr = ne((f) => e.events.on("gamepadButtonRelease", (T, P) => f(T, P)), (f, T) => e.events.on("gamepadButtonRelease", (P, B) => De(f, P) && T(P, B)));
  function hr(f, T) {
  ...
  let Ie = ne((f) => e.events.on("buttonPress", (T) => f(T)), (f, T) => e.events.on("buttonPress", (P) => De(f, P) && T(P))), Wt = ne((f) => e.events.on("buttonDown", (T) => f(T)), (f, T) => e.events.on("buttonDown", (P) => De(f, P) && T(P))), Je = ne((f) => e.events.on("buttonRelease", (T) => f(T)), (f, T) => e.events.on("buttonRelease", (P) => De(f, P) && T(P)));
  function Cn() {
  ...
  function vo(f) {
    let T = { index: f.index, isPressed: (P) => e.gamepadStates.get(f.index)?.buttonState.pressed.has(P) || false, isDown: (P) => e.gamepadStates.get(f.index)?.buttonState.down.has(P) || false, isReleased: (P) => e.gamepadStates.get(f.index)?.buttonState.released.has(P) || false, getStick: (P) => e.gamepadStates.get(f.index)?.stickState.get(P) || v() };
    return e.gamepads.push(T), e.gamepadStates.set(f.index, { buttonState: new vt(), stickState: /* @__PURE__ */ new Map([["left", new E(0)], ["right", new E(0)]]) }), T;
  }
  function Qa(f) {
    e.gamepads = e.gamepads.filter((T) => T.index !== f.index), e.gamepadStates.delete(f.index);
  }
  function Ja() {
    for (let f of navigator.getGamepads()) f && !e.gamepadStates.has(f.index) && vo(f);
    for (let f of e.gamepads) {
      let T = navigator.getGamepads()[f.index];
      if (!T) continue;
      let B = (t18.gamepads ?? {})[T.id] || Gs[T.id] || Gs.default, te = e.gamepadStates.get(f.index);
      if (te) {
        for (let Ae = 0; Ae < T.buttons.length; Ae++) {
          let se = B.buttons[Ae], Ze = T.buttons[Ae], Rt = e.buttonsByGamepad.has(se);
          if (Ze.pressed) {
            if (te.buttonState.down.has(se)) {
              e.events.trigger("gamepadButtonDown", se, f);
              continue;
            }
            e.lastInputDevice = "gamepad", Rt && e.buttonsByGamepad.get(se)?.forEach((Re) => {
          ...
          } else te.buttonState.down.has(se) && (Rt && e.buttonsByGamepad.get(se)?.forEach((Re) => {
        ...
        for (let Ae in B.sticks) {
          ...
          te.stickState.set(Ae, Ze), e.mergedGamepadState.stickState.set(Ae, Ze), e.events.trigger("gamepadStick", Ae, Ze, f);
        }
      }
    }
  }
  let Me = {}, br = {}, En = {}, wo = t18.pixelDensity || 1;
  Me.mousemove = (f) => {
    let T = Qe(new E(f.offsetX, f.offsetY)), P = new E(f.movementX, f.movementY);
    if (y()) {
      let B = e.canvas.width / wo, te = e.canvas.height / wo, Ae = window.innerWidth, se = window.innerHeight, Ze = Ae / se, Rt = B / te;
      if (Ze > Rt) {
        let Re = se / te, yr = (Ae - B * Re) / 2;
        T.x = Se(f.offsetX - yr, 0, B * Re, 0, B), T.y = Se(f.offsetY, 0, te * Re, 0, te);
      } else {
        let Re = Ae / B, yr = (se - te * Re) / 2;
        T.x = Se(f.offsetX, 0, B * Re, 0, B), T.y = Se(f.offsetY - yr, 0, te * Re, 0, te);
      }
    }
  ...
  let Za = /* @__PURE__ */ new Set([" ", "ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Tab"]), Eo = { ArrowLeft: "left", ArrowRight: "right", ArrowUp: "up", ArrowDown: "down", " ": "space" };
  Me.keydown = (f) => {
    Za.has(f.key) && f.preventDefault(), e.events.onOnce("input", () => {
      let T = Eo[f.key] || f.key.toLowerCase(), P = f.code;
      if (T === void 0) throw new Error(`Unknown key: ${f.key}`);
      T.length === 1 ? (e.events.trigger("charInput", T), e.charInputted.push(T)) : T === "space" && (e.events.trigger("charInput", " "), e.charInputted.push(" ")), f.repeat ? (e.keyState.pressRepeat(T), e.events.trigger("keyPressRepeat", T)) : (e.lastInputDevice = "keyboard", e.buttonsByKey.has(T) && e.buttonsByKey.get(T)?.forEach((B) => {
    ...
    f.preventDefault(), e.events.onOnce("input", () => {
      ...
      t18.touchToMouse !== false && (e.mousePos = Qe(new E(T[0].clientX - P.x, T[0].clientY - P.y)), e.lastInputDevice = "mouse", e.buttonsByMouse.has("left") && e.buttonsByMouse.get("left")?.forEach((B) => {
        e.buttonState.press(B), e.events.trigger("buttonPress", B);
    ...
    f.preventDefault(), e.events.onOnce("input", () => {
      ...
      if (t18.touchToMouse !== false) {
        let B = e.mousePos;
        e.mousePos = Qe(new E(T[0].clientX - P.x, T[0].clientY - P.y)), e.mouseDeltaPos = e.mousePos.sub(B), e.events.trigger("mouseMove");
      }
      T.forEach((B) => {
        e.events.trigger("touchMove", Qe(new E(B.clientX - P.x, B.clientY - P.y)), B);
      });
    });
  }, Me.touchend = (f) => {
    e.events.onOnce("input", () => {
      let T = [...f.changedTouches], P = e.canvas.getBoundingClientRect();
      t18.touchToMouse !== false && (e.mousePos = Qe(new E(T[0].clientX - P.x, T[0].clientY - P.y)), e.mouseDeltaPos = new E(0, 0), e.buttonsByMouse.has("left") && e.buttonsByMouse.get("left")?.forEach((B) => {
        e.buttonState.release(B), e.events.trigger("buttonRelease", B);
      }), e.mouseState.release("left"), e.events.trigger("mouseRelease", "left")), T.forEach((B) => {
        e.events.trigger("touchEnd", Qe(new E(B.clientX - P.x, B.clientY - P.y)), B);
      });
    });
  }, Me.touchcancel = (f) => {
    e.events.onOnce("input", () => {
      let T = [...f.changedTouches], P = e.canvas.getBoundingClientRect();
      t18.touchToMouse !== false && (e.mousePos = Qe(new E(T[0].clientX - P.x, T[0].clientY - P.y)), e.mouseState.release("left"), e.events.trigger("mouseRelease", "left")), T.forEach((B) => {
        e.events.trigger("touchEnd", Qe(new E(B.clientX - P.x, B.clientY - P.y)), B);
      });
    });
  }, Me.wheel = (f) => {
  ...
  }, Me.contextmenu = (f) => f.preventDefault(), br.visibilitychange = () => {
...
var Kn = { linear: (t18) => t18, easeInSine: (t18) => 1 - Math.cos(t18 * Math.PI / 2), easeOutSine: (t18) => Math.sin(t18 * Math.PI / 2), easeInOutSine: (t18) => -(Math.cos(Math.PI * t18) - 1) / 2, easeInQuad: (t18) => t18 * t18, easeOutQuad: (t18) => 1 - (1 - t18) * (1 - t18), easeInOutQuad: (t18) => t18 < 0.5 ? 2 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 2) / 2, easeInCubic: (t18) => t18 * t18 * t18, easeOutCubic: (t18) => 1 - Math.pow(1 - t18, 3), easeInOutCubic: (t18) => t18 < 0.5 ? 4 * t18 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 3) / 2, easeInQuart: (t18) => t18 * t18 * t18 * t18, easeOutQuart: (t18) => 1 - Math.pow(1 - t18, 4), easeInOutQuart: (t18) => t18 < 0.5 ? 8 * t18 * t18 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 4) / 2, easeInQuint: (t18) => t18 * t18 * t18 * t18 * t18, easeOutQuint: (t18) => 1 - Math.pow(1 - t18, 5), easeInOutQuint: (t18) => t18 < 0.5 ? 16 * t18 * t18 * t18 * t18 * t18 : 1 - Math.pow(-2 * t18 + 2, 5) / 2, easeInExpo: (t18) => t18 === 0 ? 0 : Math.pow(2, 10 * t18 - 10), easeOutExpo: (t18) => t18 === 1 ? 1 : 1 - Math.pow(2, -10 * t18), easeInOutExpo: (t18) => t18 === 0 ? 0 : t18 === 1 ? 1 : t18 < 0.5 ? Math.pow(2, 20 * t18 - 10) / 2 : (2 - Math.pow(2, -20 * t18 + 10)) / 2, easeInCirc: (t18) => 1 - Math.sqrt(1 - Math.pow(t18, 2)), easeOutCirc: (t18) => Math.sqrt(1 - Math.pow(t18 - 1, 2)), easeInOutCirc: (t18) => t18 < 0.5 ? (1 - Math.sqrt(1 - Math.pow(2 * t18, 2))) / 2 : (Math.sqrt(1 - Math.pow(-2 * t18 + 2, 2)) + 1) / 2, easeInBack: (t18) => Bs * t18 * t18 * t18 - 1.70158 * t18 * t18, easeOutBack: (t18) => 1 + Bs * Math.pow(t18 - 1, 3) + 1.70158 * Math.pow(t18 - 1, 2), easeInOutBack: (t18) => t18 < 0.5 ? Math.pow(2 * t18, 2) * ((In + 1) * 2 * t18 - In) / 2 : (Math.pow(2 * t18 - 2, 2) * ((In + 1) * (t18 * 2 - 2) + In) + 2) / 2, easeInElastic: (t18) => t18 === 0 ? 0 : t18 === 1 ? 1 : -Math.pow(2, 10 * t18 - 10) * Math.sin((t18 * 10 - 10.75) * Fs), easeOutElastic: (t18) => t18 === 0 ? 0 : t18 === 1 ? 1 : Math.pow(2, -10 * t18) * Math.sin((t18 * 10 - 0.75) * Fs) + 1, easeInOutElastic: (t18) => t18 === 0 ? 0 : t18 === 1 ? 1 : t18 < 0.5 ? -(Math.pow(2, 20 * t18 - 10) * Math.sin((20 * t18 - 11.125) * Ls)) / 2 : Math.pow(2, -20 * t18 + 10) * Math.sin((20 * t18 - 11.125) * Ls) / 2 + 1, easeInBounce: (t18) => 1 - Kn.easeOutBounce(1 - t18), easeOutBounce: (t18) => t18 < 1 / 2.75 ? 7.5625 * t18 * t18 : t18 < 2 / 2.75 ? 7.5625 * (t18 -= 1.5 / 2.75) * t18 + 0.75 : t18 < 2.5 / 2.75 ? 7.5625 * (t18 -= 2.25 / 2.75) * t18 + 0.9375 : 7.5625 * (t18 -= 2.625 / 2.75) * t18 + 0.984375, easeInOutBounce: (t18) => t18 < 0.5 ? (1 - Kn.easeOutBounce(1 - 2 * t18)) / 2 : (1 + Kn.easeOutBounce(2 * t18 - 1)) / 2 };
var nt = Kn;
function Wu(t18, e, n) {
  let r = [], o = e;
  for (r.push(o); o !== t18; ) {
...
function Lr(t18, e, n) {
  ...
  for (s.set(e, 0); r.length !== 0; ) {
    let i = r.remove()?.node;
    if (i === n) break;
    let m = t18.getNeighbours(i);
    for (let u of m) {
      let c = (s.get(i) || 0) + t18.getCost(i, u) + t18.getHeuristic(u, n);
...
var kn = class {
  ...
  addPolygon(e) {
    let n = new Ir(this._polygons.length), r = e.map((o, s) => new jr(o, e[(s + 1) % e.length], n));
  ...
  getPath(e, n) {
    return e === void 0 || n === void 0 ? [] : e === n ? [e, n] : Lr(this, e, n);
  }
  getWaypointPath(e, n, r) {
    let o = r?.type || "centroids", s = this._getLocation(e), i = this._getLocation(n);
...
function js(t18) {
  return new E(t18.x / ie() * 2 - 1, -t18.y / ue() * 2 + 1);
}
function wt(t18, e, n, r, o, s = 1) {
  ...
  for (let b = 0; b <= m; b++) i.push(t18.add(e * c.x, n * c.y)), c = v(c.x * p.x - c.y * p.y, c.x * p.y + c.y * p.x);
  return i;
}
function Is(...t18) {
...
function Ye(t18) {
  t18 && a.gfx.transform.rotate(t18);
}
function me() {
...
function pe(t18) {
  return typeof t18 != "string" || Fn(t18) ? t18 : a.assets.urlPrefix + t18;
}
var ce = class t14 {
  loaded = false;
  data = null;
...
function Et(t18) {
  return _r(t18).then((e) => e.json());
}
function _s(t18) {
  return _r(t18).then((e) => e.text());
}
function Ns(t18) {
  return _r(t18).then((e) => e.arrayBuffer());
}
function Us(t18) {
  return t18 !== void 0 && (a.assets.urlPrefix = t18), a.assets.urlPrefix;
}
function Hs(t18, e) {
  return a.assets.custom.add(t18, Et(pe(e)));
}
function Tt(t18) {
  let e = new Image();
...
function Be() {
  let t18 = [a.assets.sprites, a.assets.sounds, a.assets.shaders, a.assets.fonts, a.assets.bitmapFonts, a.assets.custom];
...
function qs(t18) {
  return a.assets.custom.get(t18) ?? null;
}
function cn(t18) {
  return a.assets.custom.add(null, t18);
}
var zs = (t18, e) => ({ urlPrefix: "", sprites: new ft(), fonts: new ft(), bitmapFonts: new ft(), sounds: new ft(), shaders: new ft(), custom: new ft(), music: {}, packer: new Nn(t18, 2048, 2048, e), loaded: false });
...
var Fe = class t15 {
  ...
  static fromImage(e, n = {}) {
    let [r, o] = n.singular ? a.assets.packer.addSingle(e) : a.assets.packer.add(e), s = n.frames ? n.frames.map((i) => new q(o.x + i.x * o.w, o.y + i.y * o.h, i.w * o.w, i.h * o.h)) : Ur(n.sliceX || 1, n.sliceY || 1, o.x, o.y, o.w, o.h);
    return new t15(r, s, n.anims, n.slice9);
  }
  static fromURL(e, n = {}) {
    return Tt(e).then((r) => t15.fromImage(r, n));
  }
};
function Kt(t18) {
...
function Nr(t18) {
  return a.assets.sprites.get(t18) ?? null;
}
function Ot(t18, e, n = { sliceX: 1, sliceY: 1, anims: {} }) {
  return e = pe(e), Array.isArray(e) ? e.some((r) => typeof r == "string") ? a.assets.sprites.add(t18, Promise.all(e.map((r) => typeof r == "string" ? Tt(r) : Promise.resolve(r))).then((r) => Ys(r, n))) : a.assets.sprites.addLoaded(t18, Ys(e, n)) : typeof e == "string" ? a.assets.sprites.add(t18, Fe.from(e, n)) : a.assets.sprites.addLoaded(t18, Fe.fromImage(e, n));
}
function Ur(t18 = 1, e = 1, n = 0, r = 0, o = 1, s = 1) {
  let i = [], m = o / t18, u = s / e;
  for (let c = 0; c < e; c++) for (let p = 0; p < t18; p++) i.push(new q(n + p * m, r + c * u, m, u));
  return i;
}
function Ys(t18, e = {}) {
  ...
  let i = s.getImageData(0, 0, t18.length * r, o);
  return Fe.fromImage(i, { ...e, sliceX: t18.length, sliceY: 1 });
}
function $s(t18 = "bean") {
  return Ot(t18, Ws);
}
function Xs(t18, e, n) {
  e = pe(e), n = pe(n), typeof e == "string" && !n && (n = vs(e) + ".json");
  let r = typeof n == "string" ? Et(n) : Promise.resolve(n);
  return a.assets.sprites.add(t18, r.then((o) => {
...
function Hr(t18) {
  if (!t18) return Hr(a.globalOpt.font ?? ss);
  if (typeof t18 == "string") {
    let e = Hn(t18), n = qr(t18);
...
function qr(t18) {
  return a.assets.fonts.get(t18) ?? null;
}
function Qs(t18, e, n = {}) {
  let r = pe(e), o = new FontFace(t18, typeof e == "string" ? `url(${r})` : r);
  return document.fonts.add(o), a.assets.fonts.add(t18, o.load().catch((s) => {
    throw new Error(`Failed to load font from "${r}": ${s}`);
  }).then((s) => new At(s, n)));
}
function Js(t18, e, n, r) {
  let o = t18.width / e, s = {}, i = r.split("").entries();
  for (let [m, u] of i) s[u] = new q(m % o * e, Math.floor(m / o) * n, e, n);
  return { tex: t18, map: s, size: n };
}
function Hn(t18) {
  return a.assets.bitmapFonts.get(t18) ?? null;
}
function Zs(t18, e, n, r, o = {}) {
  let s = pe(e);
  return a.assets.bitmapFonts.add(t18, Tt(s).then((i) => Js(Ve.fromImage(a.gfx.ggl, i, o), n, r, o.chars ?? Rn)));
}
function ei(t18, e) {
  return e = pe(e), a.assets.sprites.add(t18, new Promise(async (n) => {
    let r = typeof e == "string" ? await Et(e) : e, o = await Promise.all(r.frames.map(Tt)), s = document.createElement("canvas");
  ...
  send(e) {
    ...
    for (let r in e) {
      ...
      if (typeof o == "number") n.uniform1f(s, o);
        ...
        let i = o[0];
        bs(o) ? n.uniform1fv(s, o) : gs(o) ? n.uniform2fv(s, o.map((m) => [m.x, m.y]).flat()) : hs(o) && n.uniform3fv(s, o.map((m) => [m.r, m.g, m.b]).flat());
...
function qn(t18, e = tn, n = nn) {
  let r = cs.replace("{{user}}", e ?? tn), o = ls.replace("{{user}}", n ?? nn);
  try {
    return new zr(t18, r, o, en.map((s) => s.name));
  } catch (s) {
    let m = /(?<type>^\w+) SHADER ERROR: 0:(?<line>\d+): (?<msg>.+)/, u = Cs(s).match(m);
    if (!u?.groups) throw s;
...
function Wr(t18) {
  return a.assets.shaders.get(t18) ?? null;
}
function ni(t18, e, n) {
  return a.assets.shaders.addLoaded(t18, qn(a.gfx.ggl, e, n));
}
function ri(t18, e, n) {
  e = pe(e), n = pe(n);
  let r = (s) => s ? _s(s) : Promise.resolve(null), o = Promise.all([r(e), r(n)]).then(([s, i]) => qn(a.gfx.ggl, s, i));
  return a.assets.shaders.add(t18, o);
}
var ot = class t16 {
  buf;
  constructor(e) {
  ...
  static fromArrayBuffer(e) {
    return new Promise((n, r) => a.audio.ctx.decodeAudioData(e, n, r)).then((n) => new t16(n));
  }
  static fromURL(e) {
    return Fn(e) ? t16.fromArrayBuffer(ys(e)) : Ns(e).then((n) => t16.fromArrayBuffer(n));
  }
};
function oi(t18) {
  if (typeof t18 == "string") {
    ...
    if (t18 instanceof ot) return ce.loaded(t18);
    if (t18 instanceof ce) return t18;
    throw new Error(`Invalid sound: ${t18}`);
  }
}
function Yr(t18) {
  return a.assets.sounds.get(t18) ?? null;
}
function si(t18, e) {
  return e = pe(e), a.assets.sounds.add(t18, typeof e == "string" ? ot.fromURL(e) : ot.fromArrayBuffer(e));
}
function ii(t18, e) {
  let n = pe(e), r = new Audio(n);
  return r.preload = "auto", a.assets.music[t18] = n;
}
function $r(t18, e) {
  return t18 = pe(t18), typeof e == "string" ? cn(new Promise((n, r) => {
    Et(e).then((o) => {
      $r(t18, o).then(n).catch(r);
    });
  })) : cn(Fe.from(t18).then((n) => {
    let r = {};
    for (let o in e) {
      let s = e[o], i = n.frames[0], m = 2048 * i.w, u = 2048 * i.h, c = s.frames ? s.frames.map((b) => new q(i.x + (s.x + b.x) / m * i.w, i.y + (s.y + b.y) / u * i.h, b.w / m * i.w, b.h / u * i.h)) : Ur(s.sliceX || 1, s.sliceY || 1, i.x + s.x / m * i.w, i.y + s.y / u * i.h, s.width / m * i.w, s.height / u * i.h), p = new Fe(n.tex, c, s.anims);
...
function Pe(t18) {
  ...
  if (!(e < 3)) {
    if (ge(), X(t18.pos), rt(t18.scale), Ye(t18.angle), X(t18.offset), t18.fill !== false) {
      let n = t18.color ?? j.WHITE, r = t18.pts.map((s, i) => ({ pos: new E(s.x, s.y), uv: t18.uv ? t18.uv[i] : new E(0, 0), color: t18.colors && t18.colors[i] ? t18.colors[i].mult(n) : n, opacity: t18.opacity ?? 1 })), o;
      t18.triangulate ? o = Mn(t18.pts).map((i) => i.map((m) => t18.pts.indexOf(m))).flat() : o = [...Array(e - 2).keys()].map((s) => [0, s + 1, s + 2]).flat(), Le(r, t18.indices ?? o, t18.fixed, t18.uv ? t18.tex : a.gfx.defTex, t18.shader, t18.uniform ?? void 0);
    }
    t18.outline && kt({ pts: [...t18.pts, t18.pts[0]], radius: t18.radius, width: t18.outline.width, color: t18.outline.color, join: t18.outline.join, uniform: t18.uniform, fixed: t18.fixed, opacity: t18.opacity ?? t18.outline.opacity }), me();
  }
}
function zn(t18) {
  ...
  let e = t18.start ?? 0, n = t18.end ?? 360, r = _e(t18.anchor ?? "center").scale(new E(-t18.radiusX, -t18.radiusY)), o = wt(r, t18.radiusX, t18.radiusY, e, n, t18.resolution);
  o.unshift(r);
...
function _t(t18) {
  ...
  let r = t18.width || 1, o = n.sub(e).unit().normal().scale(r * 0.5), s = [e.sub(o), e.add(o), n.add(o), n.sub(o)].map((i) => ({ pos: new E(i.x, i.y), uv: new E(0), color: t18.color ?? j.WHITE, opacity: t18.opacity ?? 1 }));
  Le(s, [0, 1, 3, 1, 2, 3], t18.fixed, a.gfx.defTex, t18.shader, t18.uniform ?? void 0);
}
function $u(t18) {
  let e = t18.pts, n = [], r = (t18.width || 1) * 0.5, o = e[0] === e[e.length - 1] || e[0].eq(e[e.length - 1]), s = t18.pos || v(0, 0), i;
  ...
  if (!o) switch (n.push(p.add(u)), n.push(p.sub(u)), t18.cap) {
    case "square": {
      let d = i.scale(r / m);
      n.push(p.add(d).add(u)), n.push(p.add(d).sub(u));
      break;
  ...
  let b = n.map((d) => ({ pos: s.add(d), uv: v(), color: t18.color || j.WHITE, opacity: t18.opacity ?? 1 })), l = [], h = 0;
  for (let d = 0; d < n.length - 2; d += 2) l[h++] = d + 1, l[h++] = d, l[h++] = d + 2, l[h++] = d + 2, l[h++] = d + 3, l[h++] = d + 1;
  o && (l[h++] = n.length - 1, l[h++] = n.length - 2, l[h++] = 0, l[h++] = 0, l[h++] = 1, l[h++] = n.length - 1), Le(b, l, t18.fixed, a.gfx.defTex, t18.shader, t18.uniform ?? void 0);
}
function Xu(t18) {
  let e = t18.pts, n = [], r = (t18.width || 1) * 0.5, o = e[0] === e[e.length - 1] || e[0].eq(e[e.length - 1]), s = t18.pos || v(0, 0), i;
  o ? i = e[0].sub(e[e.length - 2]) : i = e[1].sub(e[0]);
  ...
  if (!(e.length < 2)) {
    ...
    if (t18.radius && e.length >= 3) {
      ...
      for (let r = 1; r < e.length - 2; r++) {
        let o = e[r], s = e[r + 1];
        _t(Object.assign({}, t18, { p1: o, p2: s }));
      }
      _t(Object.assign({}, t18, { p1: e[e.length - 2], p2: e[e.length - 1] }));
    } else for (let r = 0; r < e.length - 1; r++) _t(Object.assign({}, t18, { p1: e[r], p2: e[r + 1] })), t18.join !== "none" && Ne(Object.assign({}, t18, { pos: e[r], radius: n / 2 }));
  }
}
function Wn(t18, e) {
...
function ai(t18) {
  Wn((e) => Jt(t18.pt1, t18.pt2, t18.pt3, t18.pt4, e), t18);
}
var Ve = class t17 {
  ctx;
  src = null;
...
var Yn = class {
  ...
  push(e, n, r, o, s = null, i = {}) {
    (e !== this.curPrimitive || s !== this.curTex || o !== this.curShader || !Ln(this.curUniform, i) || this.vqueue.length + n.length * this.stride > this.maxVertices || this.iqueue.length + r.length > this.maxIndices) && this.flush();
...
function ui(t18, e = {}) {
  ...
  function o() {
    n.forEach((x) => x());
    let V = t18.getExtension("WEBGL_lose_context");
    V && V.loseContext();
  }
  let s = null;
  function i(V) {
    ...
    V.reduce((w, S, G) => (t18.vertexAttribPointer(G, S.size, t18.FLOAT, false, x * 4, w), t18.enableVertexAttribArray(G), w + S.size * 4), 0);
  }
  let [m, u] = St((V) => t18.bindTexture(t18.TEXTURE_2D, V)), [c, p] = St((V) => t18.bindBuffer(t18.ARRAY_BUFFER, V)), [b, l] = St((V) => t18.bindBuffer(t18.ELEMENT_ARRAY_BUFFER, V)), [h, d] = St((V) => t18.bindFramebuffer(t18.FRAMEBUFFER, V)), [C, g] = St((V) => t18.bindRenderbuffer(t18.RENDERBUFFER, V)), [y, O] = St((V) => {
    if (!V) return;
    let { x, y: w, w: S, h: G } = V;
    t18.viewport(x, w, S, G);
  }), [A, R] = St((V) => t18.useProgram(V));
  return y({ x: 0, y: 0, w: t18.drawingBufferWidth, h: t18.drawingBufferHeight }), { gl: t18, opts: e, onDestroy: r, destroy: o, pushTexture2D: m, popTexture2D: u, pushArrayBuffer: c, popArrayBuffer: p, pushElementArrayBuffer: b, popElementArrayBuffer: l, pushFramebuffer: h, popFramebuffer: d, pushRenderbuffer: C, popRenderbuffer: g, pushViewport: y, popViewport: O, pushProgram: A, popProgram: R, setVertexFormat: i };
}
var Xr = {};
function mi(t18, e) {
  if (e.override) {
...
function Ue(t18) {
  ...
  let { charStyleMap: n, text: r } = $n(t18.text + ""), o = Ts(r);
  if (e instanceof At || typeof e == "string") {
    let A = e instanceof At ? e.fontface.family : e, R = e instanceof At ? { outline: e.outline, filter: e.filter } : { outline: null, filter: Zt }, V = Xr[A] ?? { font: { tex: new Ve(a.gfx.ggl, 2048, 2048, { filter: R.filter }), map: {}, size: 64 }, cursor: new E(0), maxHeight: 0, outline: R.outline };
    ...
    for (let x of o) if (!V.font.map[x]) {
      ...
      V.outline && V.outline.width && V.outline.color && (w.lineJoin = "round", w.lineWidth = V.outline.width * 2, w.strokeStyle = V.outline.color.toHex(), w.strokeText(x, V.outline.width, V.outline.width), G += V.outline.width * 2, M += V.outline.width * 3), w.fillText(x, V.outline?.width ?? 0, V.outline?.width ?? 0);
  ...
  let s = t18.size || e.size, i = v(t18.scale ?? 1).scale(s / e.size), m = t18.lineSpacing ?? 0, u = t18.letterSpacing ?? 0, c = 0, p = 0, b = 0, l = [], h = [], d = 0, C = null, g = 0, y;
  for (; d < o.length; ) {
    let A = o[d];
    if (A === `
`) b += s + m, l.push({ width: c - u, chars: h }), C = null, g = 0, c = 0, h = [], y = void 0;
      ...
      if (R) {
        let V = R.w * i.x;
        t18.width && c + V > t18.width && (b += s + m, C != null && (d -= h.length - C, A = o[d], R = e.map[A], V = R.w * i.x, h = h.slice(0, C - 1), c = g), C = null, g = 0, l.push({ width: c - u, chars: h }), c = y ?? 0, h = []), h.push({ tex: e.tex, width: R.w, height: R.h, quad: new q(R.x / e.tex.width, R.y / e.tex.height, R.w / e.tex.width, R.h / e.tex.height), ch: A, pos: new E(c, b), opacity: t18.opacity ?? 1, color: t18.color ?? j.WHITE, scale: v(i), angle: 0 }), A === " " && (C = h.length, g = c), t18.indentAll && y === void 0 && /\S/.test(A) && (y = c), c += V, p = Math.max(p, c), c += u;
      }
    }
    d++;
  }
  l.push({ width: c - u, chars: h }), b += s, t18.width && (p = t18.width);
  let O = [];
  for (let A = 0; A < l.length; A++) {
    let R = (p - l[A].width) * Rs(t18.align ?? "left");
    for (let V of l[A].chars) {
      let x = e.map[V.ch], w = O.length + A;
      if (V.pos = V.pos.add(R, 0).add(x.w * i.x * 0.5, x.h * i.y * 0.5), t18.transform) {
        let S = typeof t18.transform == "function" ? t18.transform(w, V.ch) : t18.transform;
        S && mi(V, S);
      }
      if (n[w]) {
        let S = n[w];
        for (let G of S) {
          let M = t18.styles?.[G], D = typeof M == "function" ? M(w, V.ch) : M;
          D && mi(V, D);
        }
      }
      O.push(V);
  ...
  return { width: p, height: b, chars: O, opt: t18, renderedText: r };
}
function it(t18) {
  ...
  let e = t18.width, n = t18.height, o = _e(t18.anchor || mt).scale(new E(e, n).scale(-0.5)), s = t18.quad || new q(0, 0, 1, 1), i = t18.color || I(255, 255, 255), m = t18.opacity ?? 1, u = t18.tex ? 0.1 / t18.tex.width : 0, c = t18.tex ? 0.1 / t18.tex.height : 0, p = s.x + u, b = s.y + c, l = s.w - u * 2, h = s.h - c * 2;
  ge(), X(t18.pos), Ye(t18.angle), rt(t18.scale), X(o), Le([{ pos: new E(-e / 2, n / 2), uv: new E(t18.flipX ? p + l : p, t18.flipY ? b : b + h), color: i, opacity: m }, { pos: new E(-e / 2, -n / 2), uv: new E(t18.flipX ? p + l : p, t18.flipY ? b + h : b), color: i, opacity: m }, { pos: new E(e / 2, -n / 2), uv: new E(t18.flipX ? p : p + l, t18.flipY ? b + h : b), color: i, opacity: m }, { pos: new E(e / 2, n / 2), uv: new E(t18.flipX ? p : p + l, t18.flipY ? b : b + h), color: i, opacity: m }], [0, 1, 3, 1, 2, 3], t18.fixed, t18.tex, t18.shader, t18.uniform ?? void 0), me();
}
function He(t18) {
  ge(), X(t18.opt.pos), Ye(t18.opt.angle), X(_e(t18.opt.anchor ?? "topleft").add(1, 1).scale(t18.width, t18.height).scale(-0.5)), t18.chars.forEach((e) => {
...
function xe(t18) {
  ...
  if (t18.width <= 0 || t18.height <= 0) return;
  let e = t18.width, n = t18.height, o = _e(t18.anchor || mt).add(1, 1).scale(new E(e, n).scale(-0.5)), s = [new E(0, 0), new E(e, 0), new E(e, n), new E(0, n)];
  if (t18.radius) {
    let i = Math.min(e, n) / 2, m = Array.isArray(t18.radius) ? t18.radius.map((u) => Math.min(i, u)) : new Array(4).fill(Math.min(i, t18.radius));
    s = [new E(m[0], 0), ...m[1] ? wt(new E(e - m[1], m[1]), m[1], m[1], 270, 360) : [v(e, 0)], ...m[2] ? wt(new E(e - m[2], n - m[2]), m[2], m[2], 0, 90) : [v(e, n)], ...m[3] ? wt(new E(m[3], n - m[3]), m[3], m[3], 90, 180) : [v(0, n)], ...m[0] ? wt(new E(m[0], m[0]), m[0], m[0], 180, 270) : []];
  }
...
function qe(t18) {
  ...
  a.gfx.width = a.gfx.viewport.width, a.gfx.height = a.gfx.viewport.height, t18(), Ce(), a.gfx.width = e, a.gfx.height = n;
}
function Qr(t18, e) {
  qe(() => {
    let n = v(8);
    ge(), X(t18);
    let r = Ue({ text: e, font: yt, size: 16, pos: n, color: I(255, 255, 255), fixed: true }), o = r.width + n.x * 2, s = r.height + n.x * 2;
    t18.x + o >= ie() && X(v(-o, 0)), t18.y + s >= ue() && X(v(0, -s)), xe({ width: o, height: s, color: I(0, 0, 0), radius: 4, opacity: 0.8, fixed: true }), He(r), me();
  });
}
function Xn(t18) {
...
function di() {
  if (a.debug.inspect) {
    ...
    if (a.game.root.drawInspect(), t18) {
      let e = [], n = t18.inspect();
      for (let r in n) n[r] ? e.push(`${n[r]}`) : e.push(`${r}`);
      Qr(Ss(a.k.mousePos()), e.join(`
`));
    }
  ...
  a.debug.paused && qe(() => {
    ge(), X(ie(), 0), X(-8, 8);
    let t18 = 32;
    xe({ width: t18, height: t18, anchor: "topright", color: I(0, 0, 0), opacity: 0.8, radius: 4, fixed: true });
    for (let e = 1; e <= 2; e++) xe({ width: 4, height: t18 * 0.6, anchor: "center", pos: v(-t18 / 3 * e, t18 * 0.5), color: I(255, 255, 255), radius: 2, fixed: true });
    me();
  }), a.debug.timeScale !== 1 && qe(() => {
    ge(), X(ie(), ue()), X(-8, -8);
    let t18 = 8, e = Ue({ text: a.debug.timeScale.toFixed(1), font: yt, size: 16, color: I(255, 255, 255), pos: v(-t18), anchor: "botright", fixed: true });
    xe({ width: e.width + t18 * 2 + t18 * 4, height: e.height + t18 * 2, anchor: "botright", color: I(0, 0, 0), opacity: 0.8, radius: 4, fixed: true });
    for (let n = 0; n < 2; n++) {
    ...
    ge(), X(0, ue()), X(24, -24), Ne({ radius: 12, color: I(255, 0, 0), opacity: An(0, 1, a.app.time() * 4), fixed: true }), me();
  }), a.debug.showLog && a.game.logs.length > 0 && qe(() => {
    ge(), X(0, ue()), X(8, -8);
    let t18 = 8, e = [];
    for (let r of a.game.logs) {
      let o = "", s = r.msg instanceof Error ? "error" : "info";
      o += `[time]${r.time.toFixed(2)}[/time]`, o += " ", o += `[${s}]${Jr(r.msg)}[/${s}]`, e.push(o);
    }
    a.game.logs = a.game.logs.filter((r) => a.app.time() - r.time < (a.globalOpt.logTime || 4));
    let n = Ue({ text: e.join(`
`), font: yt, pos: v(t18, -t18), anchor: "botleft", size: 16, width: ie() * 0.6, lineSpacing: t18 / 2, fixed: true, styles: { time: { color: I(127, 127, 127) }, info: { color: I(255, 255, 255) }, error: { color: I(255, 0, 127) } } });
    xe({ width: n.width + t18 * 2, height: n.height + t18 * 2, anchor: "botleft", color: I(0, 0, 0), radius: 4, opacity: 0.8, fixed: true }), He(n), me();
  });
}
function Jr(t18, e = false, n = /* @__PURE__ */ new Set()) {
  if (n.has(t18)) return "<recursive>";
  var r = "", o;
  return e && typeof t18 == "string" && (t18 = JSON.stringify(t18)), Array.isArray(t18) && (r = ["[", t18.map((s) => Jr(s, true, n.union(/* @__PURE__ */ new Set([t18])))).join(", "), "]"].join(""), t18 = r), t18 === null ? "null" : (typeof t18 == "object" && t18.toString === Object.prototype.toString && (t18.constructor !== Object && (r += t18.constructor.name + " "), r += ["{", (o = Object.getOwnPropertyNames(t18).map((s) => `${/^\w+$/.test(s) ? s : JSON.stringify(s)}: ${Jr(t18[s], true, n.union(/* @__PURE__ */ new Set([t18])))}`).join(", ")) ? ` ${o} ` : "", "}"].join(""), t18 = r), String(t18).replaceAll(new RegExp("(?<!\\\\)\\[", "g"), "\\["));
}
function fi() {
  let t18 = a.game.cam, e = E.fromAngle(he(0, 360)).scale(t18.shake);
  t18.shake = de(t18.shake, 0, 5 * ee()), t18.transform = new fe().translate(Ct()).scale(t18.scale).rotate(t18.angle).translate((t18.pos ?? Ct()).scale(-1).add(e)), a.game.root.draw(), Ce();
}
function hi() {
  let t18 = Be();
  a.game.events.numListeners("loading") > 0 ? a.game.events.trigger("loading", t18) : qe(() => {
    let e = ie() / 2, n = 24, r = v(ie() / 2, ue() / 2).sub(v(e / 2, n / 2));
    xe({ pos: v(0), width: ie(), height: ue(), color: I(0, 0, 0) }), xe({ pos: r, width: e, height: n, fill: false, outline: { width: 4 } }), xe({ pos: r, width: e * t18, height: n });
  });
}
function Qn(t18, e, n) {
  let r = a.gfx.ggl.gl;
  Ce(), r.clear(r.STENCIL_BUFFER_BIT), r.enable(r.STENCIL_TEST), r.stencilFunc(r.NEVER, 1, 255), r.stencilOp(r.REPLACE, r.REPLACE, r.REPLACE), e(), Ce(), r.stencilFunc(n, 1, 255), r.stencilOp(r.KEEP, r.KEEP, r.KEEP), t18(), Ce(), r.disable(r.STENCIL_TEST);
}
function gi(t18, e) {
  let n = a.gfx.ggl.gl;
  Qn(t18, e, n.EQUAL);
...
function Vt(t18) {
  ...
  let e = t18.quad ?? new q(0, 0, 1, 1), n = t18.tex.width * e.w, r = t18.tex.height * e.h, o = new E(1);
  if (t18.tiled) {
    let s = _e(t18.anchor || mt), i = (t18.pos?.x || 0) - (s.x + 1) * 0.5 * (t18.width || n), m = (t18.pos?.y || 0) - (s.y + 1) * 0.5 * (t18.height || r), u = (t18.width || n) / n, c = (t18.height || r) / r, p = Math.floor(u), b = Math.floor(c), l = u - p, h = c - b, d = (p + l ? 1 : 0) * (b + h ? 1 : 0), C = new Array(d * 6), g = new Array(d * 4), y = 0, O = (A, R, V, x, w) => {
      C[y * 6 + 0] = y * 4 + 0, C[y * 6 + 1] = y * 4 + 1, C[y * 6 + 2] = y * 4 + 3, C[y * 6 + 3] = y * 4 + 1, C[y * 6 + 4] = y * 4 + 2, C[y * 6 + 5] = y * 4 + 3, g[y * 4 + 0] = { pos: new E(A - s.x, R - s.y), uv: new E(w.x, w.y), color: t18.color || j.WHITE, opacity: t18.opacity || 1 }, g[y * 4 + 1] = { pos: new E(A + V - s.x, R - s.y), uv: new E(w.x + w.w, w.y), color: t18.color || j.WHITE, opacity: t18.opacity || 1 }, g[y * 4 + 2] = { pos: new E(A + V - s.x, R + x - s.y), uv: new E(w.x + w.w, w.y + w.h), color: t18.color || j.WHITE, opacity: t18.opacity || 1 }, g[y * 4 + 3] = { pos: new E(A - s.x, R + x - s.y), uv: new E(w.x, w.y + w.h), color: t18.color || j.WHITE, opacity: t18.opacity || 1 }, y++;
    };
    for (let A = 0; A < b; A++) {
    ...
    Le(g, C, t18.fixed, t18.tex, t18.shader, t18.uniform ?? void 0);
...
function bi(t18) {
  ...
  Vt(Object.assign({}, t18, { tex: e.data.tex, quad: n.scale(t18.quad ?? new q(0, 0, 1, 1)) }));
}
function yi(t18, e) {
  let n = a.gfx.ggl.gl;
  Qn(t18, e, n.NOTEQUAL);
...
var xi = (t18, e) => {
  let n = qn(e, tn, nn), r = t18.pixelDensity ?? 1, o = t18.scale ?? 1, { gl: s } = e, i = Ve.fromImage(e, new ImageData(new Uint8ClampedArray([255, 255, 255, 255]), 1, 1)), m = t18.width && t18.height ? new st(e, t18.width * r * o, t18.height * r * o) : new st(e, s.drawingBufferWidth, s.drawingBufferHeight), u = null, c = 1;
  t18.background && (typeof t18.background == "string" ? u = I(t18.background) : (u = I(...t18.background), c = t18.background[3] ?? 1), s.clearColor(u.r / 255, u.g / 255, u.b / 255, c ?? 1)), s.enable(s.BLEND), s.blendFuncSeparate(s.ONE, s.ONE_MINUS_SRC_ALPHA, s.ONE, s.ONE_MINUS_SRC_ALPHA);
  let p = new Yn(e, en, as, us), b = Ve.fromImage(e, new ImageData(new Uint8ClampedArray([128, 128, 128, 255, 190, 190, 190, 255, 190, 190, 190, 255, 128, 128, 128, 255]), 2, 2), { wrap: "repeat", filter: "nearest" });
  return { lastDrawCalls: 0, ggl: e, defShader: n, defTex: i, frameBuffer: m, postShader: null, postShaderUniform: null, renderer: p, transform: new fe(), transformStack: [], bgTex: b, bgColor: u, bgAlpha: c, width: t18.width ?? s.drawingBufferWidth / r / o, height: t18.height ?? s.drawingBufferHeight / r / o, viewport: { x: 0, y: 0, width: s.drawingBufferWidth, height: s.drawingBufferHeight, scale: 1 }, fixed: false };
};
function at(t18) {
...
function Ci(t18 = 1) {
  ...
  return { require: ["opacity"], add() {
    ...
    r || (n += ee(), this.opacity = Se(n, 0, t18, 0, e), n >= t18 && (this.opacity = e, r = true));
  } };
}
function Ei(t18 = "intersect") {
  return { id: "mask", mask: t18 };
}
function Zn(t18) {
  return { id: "opacity", opacity: t18 ?? 1, fadeIn(e = 1, n = a.k.easings.linear) {
...
function Ti(t18 = 1, e = I(0, 0, 0), n = 1, r = "miter", o = 10, s = "butt") {
...
function Oi(t18, e) {
  let n = e.lifetime, r = [], o = t18.colors || [j.WHITE], s = t18.opacities || [1], i = t18.quads || [new q(0, 0, 1, 1)], m = t18.scales || [1], u = t18.lifeTime, c = e.direction, p = e.spread, b = t18.speed || [0, 0], l = t18.angle || [0, 0], h = t18.angularVelocity || [0, 0], d = t18.acceleration || [v(0), v(0)], C = t18.damping || [0, 0], g = [], y = new Array(t18.max), O = 0, A = 0;
  ...
  return { id: "particles", emit(x) {
    ...
    if (!(n !== void 0 && n <= 0)) {
      ...
      Le(y, g, this.fixed, t18.texture, this.shader, this.uniform);
    }
  }, onEnd(x) {
    return R.add(x);
  }, inspect() {
    return `count: ${O}/${t18.max}`;
  } };
}
function Ai(t18, e = {}) {
...
function Vi(t18, e) {
  ...
  let n = a.game.root.add([Pt(e.pos ?? v(0))]), r = t18.length, o = 0, s = null, i = null, m = null, u = null, c = (x) => x.x + x.y * o, p = (x) => v(Math.floor(x % o), Math.floor(x / o)), b = () => {
    s = [];
    ...
    let L = n.add(G);
    return M && (L.tilePosOffset = L.pos.clone()), L.tilePos = S, L.transform = dt(L), s && (l(L), this.trigger("spatialMapChanged"), this.trigger("navigationMapInvalid")), L;
  }, numColumns() {
    return o;
  }, numRows() {
    return r;
    ...
    let S = this.toWorld(x), G = this.toWorld(x.add(w)).sub(S), M = 1 / this.tileWidth(), D = x.scale(M), L = _o(D, w, (U) => {
      let H = this.getAt(U);
...
function Ge(t18, e, n) {
  return a.game.objEvents.registers[t18] || (a.game.objEvents.registers[t18] = new rn()), a.game.objEvents.on(t18, (r, ...o) => {
    r.is(e) && n(r, ...o);
  });
}
var Pi = (t18, e, ...n) => {
  for (let r of a.game.root.children) r.is(e) && r.trigger(t18, n);
};
var Gi = ne((t18) => {
  let e = a.game.root.add([{ fixedUpdate: t18 }]);
  return { get paused() {
    return e.paused;
  }, set paused(n) {
    e.paused = n;
  }, cancel: () => e.destroy() };
}, (t18, e) => Ge("fixedUpdate", t18, e));
var rr = ne((t18) => {
  let e = a.game.root.add([{ update: t18 }]);
  return { get paused() {
    return e.paused;
  }, set paused(n) {
    e.paused = n;
  }, cancel: () => e.destroy() };
}, (t18, e) => Ge("update", t18, e));
var Mi = ne((t18) => {
  let e = a.game.root.add([{ draw: t18 }]);
  return { get paused() {
    return e.hidden;
  }, set paused(n) {
    e.hidden = n;
...
var to = ne((t18) => a.game.events.on("add", t18), (t18, e) => Ge("add", t18, e));
var Ri = ne((t18) => a.game.events.on("destroy", t18), (t18, e) => Ge("destroy", t18, e));
var Di = ne((t18) => a.game.events.on("use", t18), (t18, e) => Ge("use", t18, e));
var Bi = ne((t18) => a.game.events.on("unuse", t18), (t18, e) => Ge("unuse", t18, e));
var no = ne((t18) => a.game.events.on("tag", t18), (t18, e) => Ge("tag", t18, e));
var Fi = ne((t18) => a.game.events.on("untag", t18), (t18, e) => Ge("untag", t18, e));
function Li(t18, e, n) {
  return Ge("collide", t18, (r, o, s) => o.is(e) && n(r, o, s));
}
function ji(t18, e, n) {
  return Ge("collideUpdate", t18, (r, o, s) => o.is(e) && n(r, o, s));
}
function Ii(t18, e, n) {
  return Ge("collideEnd", t18, (r, o, s) => o.is(e) && n(r, o, s));
}
function or(t18, e) {
  a.game.root.get(t18, { recursive: true }).forEach(e), to(t18, e), no((n, r) => {
    r === t18 && e(n);
  });
}
var Ki = ne((t18) => a.app.onMousePress(t18), (t18, e) => {
  let n = [];
  return or(t18, (r) => {
...
function Ui(t18) {
  a.game.events.on("loading", t18);
}
function Hi(t18) {
  a.app.onResize(t18);
}
function qi(t18) {
  a.game.events.on("error", t18);
}
function Nt(t18) {
  a.assets.loaded ? t18() : a.game.events.on("load", t18);
}
function zi(t18) {
  if (a.assets.loaded) Un().forEach((e) => t18(...e));
  else return a.game.events.on("loadError", t18);
}
function ro(...t18) {
  a.game.cam.pos = v(...t18);
}
function oo() {
  return a.game.cam.pos ? a.game.cam.pos.clone() : Ct();
}
function so(...t18) {
  a.game.cam.scale = v(...t18);
}
function io() {
  return a.game.cam.scale.clone();
}
function ao(t18) {
  a.game.cam.angle = t18;
}
function uo() {
...
function co(t18 = I(255, 255, 255), e = 1) {
  let n = a.game.root.add([tr(ie(), ue()), Jn(t18), Zn(1), ar()]), r = n.fadeOut(e);
...
function $i(t18 = 12) {
  a.game.cam.shake += t18;
}
function pn(t18) {
  return a.game.cam.transform.multVec2(t18);
}
function sr(t18) {
  return a.game.cam.transform.invert().multVec2(t18);
}
function Xi(...t18) {
  return tt("camPos", "setCamPos / getCamPos"), t18.length > 0 && ro(...t18), oo();
}
function Qi(...t18) {
  return tt("camScale", "setCamScale / getCamScale"), t18.length > 0 && so(...t18), io();
}
function Ji(t18) {
  return tt("camRot", "setCamRot / getCamRot"), t18 !== void 0 && ao(t18), uo();
}
function Zi(t18 = I(255, 255, 255), e = 1) {
  return tt("camFlash", "flash"), co(t18, e);
}
function dn(t18 = []) {
  let e = /* @__PURE__ */ new Map(), n = [], r = {}, o = new ze(), s = [], i = new Set("*"), m = a.globalOpt.tagsAsComponents, u = null, c = false, p = { id: Os(), hidden: false, transform: new fe(), children: [], parent: null, set paused(l) {
    if (l !== c) {
      c = l;
    ...
    return h.parent = this, h.transform = dt(h), this.children.push(h), h.trigger("add", h), a.game.events.trigger("add", h), h;
  }, readd(l) {
    ...
    let l = a.gfx.fixed;
    this.fixed && (a.gfx.fixed = true), ge(), X(this.pos), rt(this.scale), Ye(this.angle);
    ...
    this.hidden || (ge(), X(this.pos), rt(this.scale), Ye(this.angle), this.children.forEach((l) => l.drawInspect()), this.trigger("drawInspect"), me());
  }, use(l) {
    ...
    for (let C in l) {
      ...
      if (g) if (typeof g.value == "function" && (l[C] = l[C].bind(this)), g.set && Object.defineProperty(l, C, { set: g.set.bind(this) }), g.get && Object.defineProperty(l, C, { get: g.get.bind(this) }), ps.has(C)) {
        let y = C === "add" ? () => {
...
function aa(t18, e = {}) {
  if (typeof t18 == "string" && a.assets.music[t18]) return ia(a.assets.music[t18], e);
  ...
  return { stop() {
    ...
    o.buffer?.duration && (g > o.buffer.duration || (r ? (o = C(o), c = p - g) : (o.stop(), o = C(o), c = n.currentTime - g, o.start(0, g), b = true, p = 0)));
  }, set speed(g) {
...
function ur(t18) {
  return a.k.play(a.audio.burpSnd, t18);
}
function lo(t18) {
  a.audio.masterNode.gain.value = t18;
}
function mo() {
  return a.audio.masterNode.gain.value;
}
function ua(t18) {
  return tt("volume", "setVolume / getVolume"), t18 !== void 0 && lo(t18), mo();
}
function cr() {
  a.app.onHide(() => {
    ...
    let t18 = a.globalOpt.width && a.globalOpt.height;
    t18 && !a.globalOpt.stretch && !a.globalOpt.letterbox || (a.canvas.width = a.canvas.offsetWidth * a.pixelDensity, a.canvas.height = a.canvas.offsetHeight * a.pixelDensity, jn(), t18 || (a.gfx.frameBuffer.free(), a.gfx.frameBuffer = new st(a.gfx.ggl, a.gfx.ggl.gl.drawingBufferWidth, a.gfx.ggl.gl.drawingBufferHeight), a.gfx.width = a.gfx.ggl.gl.drawingBufferWidth / a.pixelDensity / a.gscale, a.gfx.height = a.gfx.ggl.gl.drawingBufferHeight / a.pixelDensity / a.gscale));
    ...
    a.debug.timeScale = on(Te(a.debug.timeScale + 0.2, 0, 2), 1);
  }), a.app.onKeyPress("f10", () => a.debug.stepFrame())), a.globalOpt.burp && a.app.onKeyPress("b", () => ur());
}
function ca(t18, e = {}) {
  let n = a.game.root.add([Pt(t18), lr()]), r = (e.speed || 1) * 5, o = e.scale || 1;
  n.add([fn(a.boomSprite), Ut(0), hn("center"), po(r, o), ...e.comps ?? []]);
  let s = n.add([fn(a.kaSprite), Ut(0), hn("center"), gn(), ...e.comps ?? []]);
  return s.wait(0.4 / r, () => s.use(po(r, o))), s.onDestroy(() => n.destroy()), n;
}
function fo(t18, e) {
  ...
  a.game.layers = t18, a.game.defaultLayerIndex = n;
}
function la() {
...
function ha(t18, ...e) {
  if (!a.game.scenes[t18]) throw new Error(`Scene not found: ${t18}`);
  a.game.events.onOnce("frameEnd", () => {
    a.game.events.trigger("sceneLeave", t18), a.app.events.clear(), a.game.events.clear(), a.game.objEvents.clear(), [...a.game.root.children].forEach((n) => {
      !n.stay || n.scenesToStay && !n.scenesToStay.includes(t18) ? a.game.root.remove(n) : n.trigger("sceneEnter", t18);
    }), a.game.root.clearEvents(), cr(), a.game.cam = { pos: null, scale: v(1), angle: 0, shake: 0, transform: new fe() }, a.game.scenes[t18](...e);
  }), a.game.currentScene = t18;
}
function ga(t18) {
  return a.game.events.on("sceneLeave", t18);
}
function ba() {
...
function fn(t18, e = {}) {
  ...
  return { id: "sprite", width: 0, height: 0, frame: e.frame || 0, quad: e.quad || new q(0, 0, 1, 1), animSpeed: e.animSpeed ?? 1, flipX: e.flipX ?? false, flipY: e.flipY ?? false, get sprite() {
    ...
    if (n.slice9) {
      ...
      for (let G = 0; G < 9; G++) {
        let M = S[G], D = S[G + 9];
        Vt(Object.assign(je(this), { pos: D.pos(), tex: n.tex, quad: c.scale(M), flipX: this.flipX, flipY: this.flipY, tiled: e.tiled, width: D.w, height: D.h }));
      }
    } else Vt(Object.assign(je(this), { tex: n.tex, quad: c.scale(this.quad ?? new q(0, 0, 1, 1)), flipX: this.flipX, flipY: this.flipY, tiled: e.tiled, width: this.width, height: this.height }));
  }, add() {
    let c = Kt(t18);
    c ? c.onLoad((p) => m(this, p)) : Nt(() => m(this, Kt(t18).data));
  }, update() {
...
function Ea(t18, e = {}) {
  let n = typeof t18 == "function" ? t18 : () => a.game.root.query(t18), r = e.checkFrequency || 1, o = typeof e.direction == "number" ? E.fromAngle(e.direction) : e.direction, s = 0;
...
function nr(t18 = {}) {
  let e = v(0), n = t18.isObstacle ?? false, r = t18.cost ?? 0, o = t18.edges ?? [], s = () => {
    let m = { left: 1, top: 2, right: 4, bottom: 8 };
    return o.map((u) => m[u] || 0).reduce((u, c) => u | c, 0);
  }, i = s();
  return { id: "tile", tilePosOffset: t18.offset ?? v(0), set tilePos(m) {
    let u = this.getLevel();
  ...
  constructor(e, n, r, o, s) {
    if (super(e, r, o), this.keys = n, this.interpolation === "spline") {
      ...
      for (let i = 0; i < this.keys.length - 1; i++) {
        ...
        this.curves.push(jt(p, m, c, b)), s && this.dcurves?.push(jt(p, m, c, b, Jo));
      }
    }
  }
  update(e, n) {
...
function yo(t18, e) {
  let n = { name: t18.name };
  return t18.has("animate") && (n.channels = t18.serializeAnimationChannels(), Object.assign(n, t18.serializeAnimationOptions())), t18.children.length > 0 && (n.children = t18.children.filter((r) => r.has("named")).map((r) => yo(r, r.name))), n;
}
function po(t18 = 2, e = 1) {
  let n = 0;
...
function Sa(t18, e = {}) {
  ...
  return { id: "lifespan", require: ["opacity"], add() {
    a.game.root.wait(t18, () => {
      this.opacity = this.opacity ?? 1, n > 0 ? a.game.root.tween(this.opacity, 0, n, (r) => this.opacity = r, nt.linear).onEnd(() => {
        this.destroy();
      }) : this.destroy();
    });
  } };
...
function Pa(t18, e, n) {
  ...
  let m = false;
  return { id: "state", state: t18, enterState(u, ...c) {
    ...
    m || (i("enter", t18), m = true), i("update", this.state);
  }, draw() {
    i("draw", this.state);
  }, inspect() {
...
function gn(t18 = 1e3) {
  return { id: "timer", maxLoopsPerFrame: t18, loop(e, n, r = 1 / 0, o = false) {
...
function Ra(t18 = {}) {
  ...
  return { id: "area", collisionIgnore: t18.collisionIgnore ?? [], add() {
    xo++, this.area.cursor && r.push(this.onHover(() => a.app.setCursor(this.area.cursor))), r.push(this.onCollideUpdate((o, s) => {
    ...
    let s = { outline: { width: 4 / _n(), color: I(0, 0, 255) }, anchor: this.anchor, fill: false, fixed: at(this) };
    ...
    if (typeof o == "string") return this.on("collideUpdate", (i, m) => i.is(o) && s?.(i, m));
    ...
    if (typeof o == "string") return this.on("collideEnd", (i) => i.is(o) && s?.(i));
    ...
    if (o instanceof W) {
      let i = _e(this.anchor || mt).add(1, 1).scale(-0.5).scale(o.width, o.height);
      s.translate(i);
    }
...
function Da(t18 = {}) {
  ...
  return { id: "body", require: ["pos"], vel: v(0), drag: t18.drag ?? 0, jumpForce: t18.jumpForce ?? ds, gravityScale: t18.gravityScale ?? 1, isStatic: t18.isStatic ?? false, mass: t18.mass ?? 1, add() {
    ...
    this.has("area") && (this.onCollideUpdate((u, c) => {
      ...
      if (u.trigger("beforePhysicsResolve", p), !(c.resolved || p.resolved) && !(this.isStatic && u.isStatic)) {
        if (!this.isStatic && !u.isStatic) {
          ...
          this.pos = this.pos.add(c.displacement.scale(u.mass / b)), u.pos = u.pos.add(c.displacement.scale(-this.mass / b)), this.transform = dt(this), u.transform = dt(u);
        } else {
          let b = !this.isStatic && u.isStatic ? c : c.reverse();
          b.source.pos = b.source.pos.add(b.displacement), b.source.transform = dt(b.source);
        }
    ...
    let u = un();
    u && (this.pos.x == m.x && (this.pos.x = de(s.x, i.x, u / an()), m.x = this.pos.x), this.pos.y == m.y && (this.pos.y = de(s.y, i.y, u / an()), m.y = this.pos.y));
  }, fixedUpdate() {
    if (s && (this.pos.x == m.x && (this.pos.x = s.x), this.pos.y == m.y && (this.pos.y = s.y), s = null), a.game.gravity && !this.isStatic) {
      ...
      let p = t18.maxVelocity ?? fs;
      this.vel.slen() > p * p && (this.vel = this.vel.unit().scale(p)), c.dot(a.game.gravity) < 0 && this.vel.dot(a.game.gravity) >= 0 && this.trigger("fall");
    }
    if (this.vel.x += o.x * ee(), this.vel.y += o.y * ee(), this.vel.x *= 1 - this.drag * ee(), this.vel.y *= 1 - this.drag * ee(), this.move(this.vel), un()) {
      s = this.pos.clone();
...
function Fa(t18) {
  return { id: "surfaceEffector", require: ["area"], speed: t18.speed, speedVariation: t18.speedVariation ?? 0, forceScale: t18.speedVariation ?? 0.9, add() {
    this.onCollideUpdate("body", (e, n) => {
      let r = n?.normal.normal(), o = e.vel.project(r), i = r?.scale(this.speed)?.sub(o);
...
function Na(t18) {
  let e = a.game.layers?.indexOf(t18);
  return { id: "layer", get layerIndex() {
    return e ?? null;
  }, get layer() {
    return e ? a.game.layers?.[e] ?? null : null;
  }, set layer(n) {
    if (e = a.game.layers?.indexOf(n), e == -1) throw Error("Invalid layer name");
  }, inspect() {
...
function Ha(t18 = {}) {
  let e = false, n = new W(v(0), ie(), ue()), r = new W(v(0), 0, 0), o = (s) => {
    s.isOffScreen() ? (e || (s.trigger("exitView"), e = true), t18.hide && (s.hidden = true), t18.pause && (s.paused = true), t18.destroy && s.destroy()) : (e && (s.trigger("enterView"), e = false), t18.hide && (s.hidden = false), t18.pause && (s.paused = false));
  };
  return { id: "offscreen", require: ["pos"], offscreenDistance: t18.distance ?? Gr, isOffScreen() {
    ...
    t18.pause && t18.unpause ? rr(() => o(this)) : this.onUpdate(() => o(this));
  } };
}
function Pt(...t18) {
...
var ic = (t18 = { tagsAsComponents: true }) => {
  a.k && (console.warn("KAPLAY already initialized, you are calling kaplay() multiple times, it may lead bugs!"), a.k.quit()), a.globalOpt = t18;
  ...
  a.fontCacheC2d = u;
  let c = Ms({ canvas: n, touchToMouse: t18.touchToMouse, gamepads: t18.gamepads, pixelDensity: t18.pixelDensity, maxFPS: t18.maxFPS, buttons: t18.buttons });
  a.app = c;
  ...
  let l = b, h = ui(l, { texFilter: t18.texFilter }), d = xi(t18, h);
  a.gfx = d;
  let C = sa();
  a.audio = C;
  let g = zs(h, t18.spriteAtlasPadding ?? 0);
  a.assets = g;
  let y = ea();
  ...
  function A() {
    l.clear(l.COLOR_BUFFER_BIT), d.frameBuffer.bind(), l.clear(l.COLOR_BUFFER_BIT), d.bgColor || qe(() => {
      it({ width: ie(), height: ue(), quad: new q(0, 0, ie() / 64, ue() / 64), tex: d.bgTex, fixed: true });
  ...
  function V() {
    ...
    d.width = l.drawingBufferWidth / i, d.height = l.drawingBufferHeight / i, Vt({ flipY: true, tex: d.frameBuffer.tex, pos: new E(d.viewport.x, d.viewport.y), width: d.viewport.width, height: d.viewport.height, shader: d.postShader, uniform: typeof d.postShaderUniform == "function" ? d.postShaderUniform() : d.postShaderUniform, fixed: true }), Ce(), d.width = F, d.height = N;
  }
  ...
  let U = y.root.add.bind(y.root), H = y.root.readd.bind(y.root), Y = y.root.removeAll.bind(y.root), _ = y.root.get.bind(y.root), K = y.root.wait.bind(y.root), J = y.root.loop.bind(y.root), $ = y.root.query.bind(y.root), Z = y.root.tween.bind(y.root), Ee = Ot(null, Ya), k = Ot(null, Wa);
        ...
        for (let Xe = dr; Xe <= hr; Xe++) for (let ct = fr; ct <= gr; ct++) if (!F[Xe]) F[Xe] = {}, F[Xe][ct] = [ve];
          ...
          e: for (let Ie of zt) {
            ...
            if (Wt) {
              ...
              let Cn = Je.reverse();
              Cn.resolved = Je.resolved, Ie.trigger("collideUpdate", ve, Cn);
            }
            wn.add(Ie.id);
          }
          zt.push(ve);
  ...
  function xn(F) {
    ...
    c.run(() => {
      ...
      A(), qe(() => {
        let ye = ie(), Q = ue(), ve = { size: 36, width: ye - 32 * 2, letterSpacing: 4, lineSpacing: 4, font: yt, fixed: true };
        xe({ width: ye, height: Q, color: I(0, 0, 255), fixed: true });
        let qt = Ue({ ...ve, text: "Error", pos: v(32), color: I(255, 128, 0), fixed: true });
        He(qt), Zr({ ...ve, text: N, pos: v(32, 32 + qt.height + 16), fixed: true }), me(), y.events.trigger("error", F);
      }), V();
    });
  }
  function mr(F) {
  ...
  a.k = $e;
  let vn = t18.plugins;
  if (vn && vn.forEach(M), t18.global !== false) for (let F in $e) window[F] = $e[F];
